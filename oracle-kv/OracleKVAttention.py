...
class OracleKVAttention(nn.Module):
    ...
    def forward(
        ...
        # TODO: OracleKVAttention may support batch size > 1 in the future
        assert bsz == 1, "QuestAttention only supports batch size 1."
        assert hasattr(self, 'layer_idx'), "OracleKVAttention requires layer_idx to inference."
        ...
        # Manages KV-Cache internal (with PageAttention)
